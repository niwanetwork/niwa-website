...
<div class="main">
    ...
    <ol>
        <li>Your wiki's subject must be Nintendo-related. If it isn't, we may be willing to offer another manner of affiliation. For guidance on which games on Nintendo platforms qualify, please refer to <a href="https://en.wikipedia.org/wiki/List_of_video_games_published_by_Nintendo">this list</a>.</li>
        <li>You and your staff should be familiar and enthusiastic about your subject's franchise.</li>
        <li>You should be prepared to pay for your own hosting, as NIWA is not a wiki host. We are willing to recommend hosts and inform you of hosts with whom we've had bad experiences.</li>
        <li>Your wiki should be operational, have a "complete" layout, and a competent active staff. A complete layout should be functional, aesthetically pleasing, and have all obvious features in place. No "under construction" or "content coming soon" labels should be present. Structural, Administration, and Policy Pages should be clearly defined and accessible.</li>
        <li>Your wiki must be independent, meaning it is not hosted by any of the following: Wikia/Fandom, ShoutWiki, WikiFoundry, etc. Please be aware that this is not a full list. If you are concerned over whether or not your host is independent, please contact us.</li>
        <li>You should have at least 75 articles, with a stub ratio of no more than 3 stubs for every 1 article (or <75% stubs).</li> <li>Your wiki should have a bit of "staying power" - that is to say, you must prove you have what it takes to last a while. Minimum wiki age of six months, with legitimate recent activity.</li>
