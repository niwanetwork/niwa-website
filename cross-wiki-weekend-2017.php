...
<div id="main">
	...
	<table style="margin: 5px; width: 100%;">
		<tr>
			...
			<td style="padding: 8px 4px; text-align: center; width: 25%;"><a style="font-weight: normal;" href="https://www.dkwiki.com/DKWiki:Community_Portal"><img src="/images/logos/donkeykongwiki.png" alt="DK Wiki" width="90px"><br/>Community Portal</a></td>
		...
		<tr>
			<td style="padding: 8px 4px; text-align: center; width: 25%;"><a style="font-weight: normal;" href="http://www.kidicaruswiki.org/Help:Getting_Started"><img src="/images/logos/icaruspedia.png" alt="Icaruspedia" width="90px"><br/>Getting Started</a></td>
			...
			<td style="padding: 8px 4px; text-align: center; width: 25%;"><a style="font-weight: normal;" href="http://starfoxwiki.info/wiki/Lylat_Wiki:To-Do_List"><img src="/images/logos/lylatwiki.png" alt="Lylat Wiki" width="90px"><br/>To-Do List</a></td>
